...
public class NewBookAdapter extends FirebaseRecyclerAdapter<Book,NewBookAdapter.myViewHodel>{
    private Context context;
    private FirebaseRecyclerOptions<Book> options;
    public NewBookAdapter(Context context,@NonNull FirebaseRecyclerOptions<Book> options) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull NewBookAdapter.myViewHodel holder, @SuppressLint("RecyclerView") int position, @NonNull Book model) {
        ...
        holder.v1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, ViewNewBook_Activity.class);
                intent.putExtra("key",getRef(position).getKey());
                context.startActivity(intent);
            }
        });

        holder.v1.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
                ...
                builder.setMessage("Bạn có muôn xoá không ?")
                        ...
                        .setPositiveButton("Có", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                FirebaseDatabase.getInstance().getReference().child("NewBook")
