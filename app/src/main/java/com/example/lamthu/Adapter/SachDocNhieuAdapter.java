...
import com.example.lamthu.SachDocNhieu_Activity;
import com.example.lamthu.ViewNewBook_Activity;
...
public class SachDocNhieuAdapter extends FirebaseRecyclerAdapter<Book,SachDocNhieuAdapter.myViewHodel> {

    private Context context;
    private FirebaseRecyclerOptions<Book> options;
    public SachDocNhieuAdapter(Context context,@NonNull FirebaseRecyclerOptions<Book> options) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull myViewHodel holder, @SuppressLint("RecyclerView") int position, @NonNull Book model) {
        ...
        holder.v2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, SachDocNhieu_Activity.class);
                intent.putExtra("key",getRef(position).getKey());
                context.startActivity(intent);
            }
        });

        holder.v2.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
                ...
                builder.setMessage("Bạn có muôn xoá không")
                        ...
                        .setPositiveButton("Có", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                FirebaseDatabase.getInstance().getReference().child("SachDocNhieu")
    ...
    public myViewHodel onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sachdocnhieu,parent,false);

        return new SachDocNhieuAdapter.myViewHodel(view);
    }
    ...
    public class myViewHodel  extends RecyclerView.ViewHolder{
        ...
        public myViewHodel(@NonNull View itemView) {
            super(itemView);
            tv_ten = itemView.findViewById(R.id.tv_nameBook_docNhieu);
            tv_tacGia = itemView.findViewById(R.id.tv_tacGia_docNhieu);
            avt_book = itemView.findViewById(R.id.avt_itemBook_docNhieu);
            v2 = itemView;
